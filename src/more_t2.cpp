...
int main(int argc, char** argv) {
    ...
    VideoCapture cap("/home/parallels/catkin_ws/src/more_t2/videos/cube_left.avi"); // open the video file for reading
...
int artest() {
    ...
    for (int i = 0; i < 16; i++)
        ROS_INFO("%.2f  %s", tracker.getModelViewMatrix()[i], (i % 4 == 3) ? "\n  " : "");
    return 0;
}