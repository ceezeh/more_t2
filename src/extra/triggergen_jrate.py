...
class TriggerGen(tk.Frame):
	...
	def __init__(self, parent, *args, **kwargs):
		...
		frame2.grid(row=6)
		cameralist =  {	"ACam1", "ACam2", "ACam3", "ACam4", "ACam6", "ACam8"}
		...
		tasklist =  {	"lap1 Corner1", "lap1 Corner2", "lap1 Corner3", "lap1 Corner4","lap2 Corner1","lap2 Corner2","lap2 Corner3","lap2 Corner4"}
