...
static int get_vertex( int x_coord[], int y_coord[], int st,  int ed,
 ...
 ARMarkerInfo2*
Tracker::arDetectMarker2(int/*16_t*/ *limage, int label_num, int *label_ref,
                    ...
                    int area_max, int area_min, ARFloat factor, int *marker_num)
{
 ...
 int
Tracker::arGetContour(int/*16_t*/ *limage, int *label_ref, int label, int clip[4], ARMarkerInfo2 *marker_infoTWO)
{
