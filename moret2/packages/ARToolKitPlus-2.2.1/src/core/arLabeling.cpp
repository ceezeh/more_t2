...
#define _DEF_PIXEL_FORMAT_YUY2
#define LABEL_FUNC_NAME arLabeling_YUY2
#include "arLabelingImpl.h"
#undef _DEF_PIXEL_FORMAT_YUY2
...
Tracker::arLabeling(uint8_t *image, int thresh, int *label_num, int **area, ARFloat **pos, int **clip,
	...
	case PIXEL_FORMAT_YUY2:
        ret = arLabeling_YUY2(image, thresh, label_num, area, pos, clip, label_ref);
        break;
