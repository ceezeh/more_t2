...
class MyAVIFileSink: public Medium {
public:
  static MyAVIFileSink* createNew(UsageEnvironment& env,
...
private:
  MyAVIFileSink(UsageEnvironment& env, MediaSession& inputSession,
	      char const* outputFileName, Boolean trig, unsigned bufferSize,
	      unsigned short movieWidth, unsigned short movieHeight,
	      unsigned movieFPS, Boolean packetLossCompensate);
      // called only by createNew()
  virtual ~MyAVIFileSink();
